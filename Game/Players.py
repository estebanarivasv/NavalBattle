...
class Player:
    ...
    def attack(self, enemy):
        while True:
            print(f"\n\n=======================================================\n"
                  f"\nTurno del jugador N°{self.getNumber()}: {self.getName()}")
